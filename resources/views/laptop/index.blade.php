<x-layouts>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('add_laptop')}}" class="btn btn-sm btn-primary waves-effect waves-light mb-2">
                                    <span class="btn-label"><i class="mdi mdi-plus"></i></span>Add Data
                                </a>
                                <button class="btn btn-sm btn-success waves-effect waves-light mb-2" data-toggle="modal" data-target="#modal-filter"><span class="btn-label"><i class="mdi mdi-filter"></i></span>Filter</button>
                                    ...
                                    <tbody>
                                        @foreach ($laptops as $item)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{route('edit_laptop', ['laptop' => $item->code])}}" class="btn btn-xs btn-primary p-1 mr-2"><i class="fe-edit-1 mr-1"></i>Edit</a>
                                                    ...
                                                    <form id="frmDelete-{{ $item->code }}"  action="{{route('delete_laptop', ['laptop' => $item->code])}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal fade modal-view" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Detail Data Laptop</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="status_laptop" disabled>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="modal-header">
                            <h4 class="modal-title">Equip Laptop</h4>
                        </div>
                        <div class="modal-body" id="data-equiplaptop">
                            <div class="row"></div>
                        </div>
                    </div>
                </div>
     ...
     <!--  Modal content for the Large example -->
    <div class="modal fade" id="modal-filter" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Filter Laptop</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <label for="code">Filter By</label>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <select class="form-control form-control-sm" id="code">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm" id="device_id"> 
                            </div>
                        </div>
                    </div>
                    <div class="row">
