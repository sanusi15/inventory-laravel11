...
var randomizeArray = function (e) {
        for (var o, t, a = e.slice(), r = a.length; 0 !== r; )
...
colors = ["#6658dd"];
(dataColors = $("#apex-column-2").data("colors")) &&
    (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "bar", toolbar: { show: !1 } },
...
colors = ["#1abc9c"];
(dataColors = $("#apex-bar-1").data("colors")) &&
    (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "bar", toolbar: { show: !1 } },
...
colors = ["#6658dd", "#1abc9c"];
(dataColors = $("#apex-bar-2").data("colors")) &&
    (colors = dataColors.split(","));
options = {
...
(dataColors = $("#apex-mixed-2").data("colors")) &&
    (colors = dataColors.split(","));
options = {
    chart: {
        height: 380,
...
(dataColors = $("#apex-mixed-3").data("colors")) &&
    (colors = dataColors.split(","));
options = {
...
colors = ["#6658dd,#1abc9c,#f672a7"];
(dataColors = $("#apex-bubble-1").data("colors")) &&
    (colors = dataColors.split(","));
options = {
...
(dataColors = $("#apex-bubble-2").data("colors")) &&
    (colors = dataColors.split(","));
var options2 = {
    chart: { height: 380, type: "bubble", toolbar: { show: !1 } },
    dataLabels: { enabled: !1 },
...
(dataColors = $("#apex-scatter-2").data("colors")) &&
    (colors = dataColors.split(","));
options = {
...
(dataColors = $("#apex-candlestick-2").data("colors")) &&
    (colors = dataColors.split(","));
...
(dataColors = $("#apex-candlestick-3").data("colors")) &&
    (colors = dataColors.split(","));
options = {
    chart: {
        height: 160,
...
colors = ["#6c757d"];
(dataColors = $("#apex-radialbar-1").data("colors")) &&
    (colors = dataColors.split(","));
options = {
